-- Partie 2 VALORISATION DES TABLES

--Valorisation de la table pays :
    --Exécuter la requête d’insertion des données :

    NSERT INTO pays (pays_id, nom) VALUES
...
-- Vérifier le contenu de la table avec la requête :
        SELECT * FROM pays


--Valorisation de la table villes :
    --Exécuter la requête d’insertion des données :
...
--Valorisation de la table parcs :
    --Exécuter la requête d’insertion des données :


NSERT INTO parcs (parc_id, nom, fk_ville_id, date_ouverture, superficie) VALUES
...
--Valorisation de la table frequentations :
    -- Exécuter la requête d’insertion des données 
...
--Valorisation de la table constructeurs :
    --Exécuter la requête d’insertion des données :
...
--Valorisation de la table elements :
    -- Exécuter la requête d’insertion des données :
...
--Valorisation de la table rollercoasters :
        --Exécuter la requête d’insertion des données :
...
--Valorisation de la table compositions :
        --Exécuter la requête d’insertion des données :
